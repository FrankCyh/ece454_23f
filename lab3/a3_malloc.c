...
// The memory pool is on the data area of the program. It is a static array of 10,000 bytes
#define HEAPSIZE 10000
char h_mem[HEAPSIZE] = {0};

// The linked list `h_List` consisting of `h_Node` is on the heap area of the program. Allocated using `
struct h_Node {
...
struct h_Node *find_header_block(void *address, struct h_Node *head) {
    ...
    // `head`: head of the linked list of headers
...
// Best fit algorithm. Find the free block closest to the request size.
